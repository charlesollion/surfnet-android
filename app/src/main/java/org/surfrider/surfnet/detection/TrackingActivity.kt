...
class TrackingActivity : CameraActivity(), CvCameraViewListener2, LocationListener {
    ...
    companion object {
        ...
        // private const val MODEL_STRING = "yolov8n-surfnet_float16.tflite"
        private const val MODEL_STRING = "yolov8n-urbanet_float16.tflite"
        private const val MODEL_TYPE = "detection"
        private const val LABEL_FILENAME = "file:///android_asset/labelmap_vipare.txt"
